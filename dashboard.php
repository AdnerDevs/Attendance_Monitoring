                            ...
                            <div class="inner text-white p-4">
                                ...
                                <div class="input-group mb-2">
                                    <select class="form-select" aria-label=" select example" id="activity_type">
                                        <?php
                                        $get_act = $activity_model->getAllActivityDisplay();
    ...
    <script>
        $(document).ready(function () {
            ...
            function checkTime() {
                ...
                if (localStorage.getItem('endAttendance') != null && localStorage.getItem('back2') != null) {
                    if (hours === 17 && minutes === 00) {
                        $('#back2').click();
                        $('#endAttendance').click();
                        notification();
                        alert('You have consumed your working hours!');
                ...
                if (localStorage.getItem('endAttendance') != null && localStorage.getItem('back2') == null) {
                    if (hours === 17 && minutes === 00) {
                        $('#endAttendance').click();
                        notification();
                        alert('You have consumed your working hours! All ongoing activity will end automatically. If you are planning to work overtime, please log your attendance again. Thank you!');
                    }
                    ...
                    Notification.requestPermission().then(function (permission) {
                        if (permission === 'granted') {
                            ...
                            var notification = new Notification('Alert', {
                                body: 'Dear employee, You have consumed your working hours! All ongoing activity will end automatically. If you are planning to work overtime, please log your attendance again. Thank you!',
            ...
            function getSeconds() {
                ...
                activity__type = "1";
                hidden_employee_attendance_id = localStorage.getItem('employee_attendance_id');
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.status === 'success') {
                            ...
                            getEmployeeData();
                            localStorage.removeItem('endAttendance');
                            localStorage.removeItem('employee_attendance_id');
                        } else {
            ...
            function getSecondsAct() {
                ...
                hidden_employee_attendance_id = localStorage.getItem('activity_employee_attendance_id');
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result.status === 'success') {
                            ...
                            localStorage.removeItem('back2');
                            localStorage.removeItem('activity_employee_attendance_id');
                            start_time = 0;
                            activity__type = 0;
                            hidden_employee_attendance_id = 0;
                            getEmployeeData();
