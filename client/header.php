...
<body>
    <header class="navbar navbar-expand-lg bd-navbar sticky-top navbar-dark bg-dark">
            <nav class="container-fluid bd-gutter flex-wrap flex-lg-nowrap" aria-label="Main Navigation">
                    <a href="../" class="navbar-brand" style="color: #00FF7F;">
                        FiveTwenty
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-center" tabindex="-1" id="navbarCollapse" data-bs-scroll="true">
