...
<div class="table-responsive">
  ...
  <table class="table" id="myTable">
    ...
    <tbody>
      ...
      foreach ($dp as $dept) :
        $status = 'Active';
        $btnLabel = '<i class="fa fa-eye-slash" aria-hidden="true"></i>';
        $classState = 'text-primary';
        $archive = 1;
        if ($dept['isArchive'] == 1) {
          $status = 'Archived';
          $btnLabel = '<i class="fa fa-eye" aria-hidden="true"></i>';
      ...
      ?>
        <tr>
          ...
          <td>
            <button type="button" class="btn btn-primary me-2 EditDepartmentBtn" id="" data-bs-dept="<?= $dept['department_name'] ?>" data-bs-id="<?= $dept['department_id'] ?>" data-bs-toggle="modal" data-bs-target="#EditDepartmentModal"><i class="fa fa-pencil" aria-hidden="true"></i></button>

            <button type="button" class="btn btn-danger me-2 DeleteDepartmentBtn" data-bs-id="<?= $dept['department_id'] ?>" data-bs-toggle="modal" data-bs-target="#DeleteDepartmentModal" data-bs-dept="<?= $dept['department_name'] ?>" data-bs-id="<?= $dept['department_id'] ?>" data-bs-delete-dept="<?= $archive ?>"><i class="fa fa-trash" aria-hidden="true"></i></button>
